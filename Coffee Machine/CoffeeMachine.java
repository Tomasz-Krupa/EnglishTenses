...
public class CoffeeMachine {
    static class Prompts
    {
        ...
        public final static String BUY_INSUFFICIENT_RESOURCES = "Sorry, not enough ";// + lackingResource + "!");
     ...
     * Zasoby maszyny
     */
    private IngredientsState resources = new IngredientsState();
    /**
     ...
     * @return czy komunikat jest dostepny
     */
